      ...
      <div class="box-container">
         ...
         ?>
               <div class="box">
                  ...
                  <p> vos articles : <span><?php echo $fetch_orders['total_products']; ?></span> </p>
                  <p> prix total : <span><?php echo $fetch_orders['total_price']; ?>€</span> </p>
                  <p> statut du paiement : <span style="color:<?php if ($fetch_orders['payment_status'] == 'pending') {
                                                                  echo 'red';
                                                               } else {
                                                                  echo 'green';
                                                               } ?>;"><?php echo ($fetch_orders['payment_status'] == 'pending') ? 'en attente' : 'complété'; ?></span> </p>
               </div>
         <?php
            }
         } else {
